...
3. Bugs find its way into production (lack of empathy for customer)
...
As an aside, parsing data to a typed object is often very useful, I've found [pydantic](https://pydantic-docs.helpmanual.io/) to be extremely helpful in reducing errors associated with parsing json documents that drive business logic.
